...
public class Usuario implements Serializable {
    ...
    public Usuario imagem(byte[] imagem) {
    ...
    public Usuario imagemContentType(String imagemContentType) {
    ...
    public Usuario noticias(Noticia noticia) {
        this.setNoticias(noticia);
        return this;
    }
